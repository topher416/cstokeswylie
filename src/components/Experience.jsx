...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      highlights: [
        'Collaborated with Development staff on grant research, proposal writing, and reporting to support institutional fundraising directly related to season planning and the New Play Sounding Series',
        'Facilitated and secured funding for SLAC\'s New Play Sounding Series, leading 11 workshops for new plays from 2019 to 2024',
        'Served as central point of contact for Board communications regarding season narratives and program outcomes',
        'Managed long-term calendars, deadlines, and documentation across departments',
        'Built partnerships with community organizations to expand engagement (YWCA Utah, Volunteers of America, Flourish Bakery)',
        'Designed and maintained internal systems to improve workflow, tracking, and cross-team communication',
        'Facilitated audience discussions and public programs rooted in equity, access, and community dialogue',
        'Read hundreds of scripts annually; championed world premieres by nationally recognized playwrights',
      ],
    },
    {
      id: 3,
