      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-accent/10 border-2 border-accent rounded-lg p-6 mb-8 max-w-2xl mx-auto">
          ...
          <p className="text-text">
            Seeking associate producer, production management, literary management, education, development, grant writing, or arts administration roles at mission-driven theater organizations.
