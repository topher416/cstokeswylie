...
const Portfolio = () => {
  ...
  const portfolioItems = [
    {
      id: 1,
      title: 'New Play Sounding Series',
      category: 'Development & Administration',
      location: 'Salt Lake City, UT',
      year: '2018-2024',
      description:
        'Managed SLAC\'s signature new play development program, selecting scripts, coordinating casting, and facilitating post-reading talkbacks. Championed emerging voices and helped shepherd works from first reading to full production.',
      links: [
        { href: 'https://www.saltlakeactingcompany.org/about/latest-news/item/1622-npss-sleeping-giant', label: 'SLAC\'s NPSS — Sleeping Giant' },
      ],
    },
    {
      id: 2,
      title: 'Playwrights\' Lab Productions',
      category: 'Development & Administration',
      location: 'Salt Lake City, UT',
      year: '2018-2024',
      description:
        'Coordinated developmental workshops bringing playwrights to Salt Lake City for intensive script development. Facilitated collaboration between writers, directors, and actors to refine new works before production.',
      links: [
        { href: 'https://www.saltlakeactingcompany.org/', label: 'Salt Lake Acting Company' },
      ],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      year: '2022',
      description:
        'Developed through SLAC\'s new-play pipeline and performed in production. Steve Yockey\'s surreal, darkly comic mosaic about belief and the monsters we wake. Participated in developmental reading before originating multiple characters in a four-actor ensemble.',
      links: [
    ...
    },
    {
      ...
      year: '2019',
      description:
        'Developed through SLAC\'s 2018 Playwrights\' Lab and performed lead role in production. Two-hander about an American engineer and her Kenyan colleague whose friendship buckles under class, politics, and power. Opened SLAC\'s 49th season.',
      links: [
